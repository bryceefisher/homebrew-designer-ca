...
namespace MVC_Homebrew_Recipe_Designer.Migrations
{
    ...
    [Migration("20240127163654_UpdateAppUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomebrewDesigner.Core.Domain.Entities.Fermentables", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomebrewDesigner.Core.Domain.Entities.Hop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomebrewDesigner.Core.Domain.Entities.HopAddition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomebrewDesigner.Core.Domain.Entities.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomebrewDesigner.Core.Domain.Entities.Recipe+FermentablePair", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomebrewDesigner.Core.Domain.Entities.Yeast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomebrewDesigner.Core.Domain.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HomebrewDesigner.Core.Domain.Entities.HopAddition", b =>
                {
                    b.HasOne("HomebrewDesigner.Core.Domain.Entities.Hop", "Hop")
                        .WithMany()
                        .HasForeignKey("HopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HomebrewDesigner.Core.Domain.Entities.Recipe", null)
            ...
            modelBuilder.Entity("HomebrewDesigner.Core.Domain.Entities.Recipe", b =>
                {
                    b.HasOne("HomebrewDesigner.Core.Domain.Entities.Yeast", "Yeast")
                        .WithMany()
            ...
            modelBuilder.Entity("HomebrewDesigner.Core.Domain.Entities.Recipe+FermentablePair", b =>
                {
                    b.HasOne("HomebrewDesigner.Core.Domain.Entities.Fermentables", "Fermentable")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HomebrewDesigner.Core.Domain.Identity.ApplicationUser", null)
                        .WithMany()
